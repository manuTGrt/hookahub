...
class MainNavigationPageState extends State<MainNavigationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: _hideTopBar ? null : PreferredSize(
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: _isSearching
                          ? SizedBox(
                              ...
                              child: TextField(
                                  ...
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (_) => SearchResultsPage(
                                        query: value,
                                        tobaccos: searchProvider.tobaccoResults,
                                        mixes: searchProvider.mixResults,
                                      ),
                                    ),
                                  );
                                ...
                                decoration: InputDecoration(
                                  hintText: 'Buscar tabacos, mezclas...',
                                  filled: true,
                                  fillColor: isDark
                          ...
                          : Align(
                              ...
                              child: Text(
                                _overrideTitles[_currentIndex] ?? _pageTitles[_currentIndex],
                          ...
                          Container(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) => CreateMixPage(currentUser: 'Yo'),
                                  ),
                                );
                              },
                            ),
      ...
      body: Stack(
        children: List.generate(_pageBuilders.length, (index) {
          ...
          _navigatorCache[index] ??= index == 0 ? _buildTabNavigator(index) : null;
          final Widget child = _navigatorCache[index] ?? const SizedBox.shrink();
          return Offstage(
            offstage: !isActive,
            child: TickerMode(
              enabled: isActive,
  ...
  Widget _buildTabNavigator(int index) {
    return Navigator(
      ...
      onGenerateInitialRoutes: (_, __) {
        ...
        return [
          MaterialPageRoute(builder: _pageBuilders[index]),
        ];
      },
    );
  }
